...
abstract class Core_DataGrid_Pager_Abstract implements Core_DataGrid_Pager_Abstract_Interface
{
	...
	{
		$this->_onPage = ceil($this->getPage() ? $this->getPage() : 1 / $this->getLimit());
		return $this;
	}
	...
	{
		$urlParams = array_merge($this->urlParams,array('page' => $page));
		return Zend_Controller_Action_HelperBroker::getStaticHelper('url')->url($urlParams, null, $emptyQuery);
	}
