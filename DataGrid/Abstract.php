...
abstract class Core_DataGrid_Abstract implements Core_DataGrid_Abstract_Interface, Countable, IteratorAggregate
{
	...
	{
		$pager = Core_DataGrid_Pager::factory($adapterName, $this->getPage(), $this->getLimit(), $this->getNumberRecords());
		if($pager instanceof Core_DataGrid_Pager_Abstract_Standard) {
			$pager->setUrlParams($this->urlParams);
		}
